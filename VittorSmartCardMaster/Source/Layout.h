...
class CLayout {
	...
	public:
		...
		bool CallProc( HWND handle, WORD notify_code );
		bool CallProc( HMENU ID, WORD notify_code );
		bool CallProc( string name, WORD notify_code );
		
		bool CreateGroup( DWORD x, DWORD y, DWORD width, DWORD height, const string& caption, const string& name, const string& parent, UINT addition = 0, WDGPROC proc = 0 );
		bool CreateStatic( DWORD x, DWORD y, DWORD width, DWORD height, const char* caption, const string& name, const string& parent, UINT  addition = 0, WDGPROC proc = 0 );
		bool CreateCombo( DWORD x, DWORD y, DWORD width, DWORD height, const char* caption, const string& name, const string& parent, UINT addition = 0, WDGPROC proc = 0 );
		bool CreateButton( DWORD x, DWORD y, DWORD width, DWORD height, const char* caption, const string& name, const string& parent, UINT  addition = 0, WDGPROC proc = 0 );
		bool CreateRadio( DWORD x, DWORD y, DWORD width, DWORD height, const char* caption, const string& name, const string& parent, UINT  addition = 0, WDGPROC proc = 0 );
		bool CreateCheck( DWORD x, DWORD y, DWORD width, DWORD height, const char* caption, const string& name, const string& parent, UINT  addition = 0, WDGPROC proc = 0 );
