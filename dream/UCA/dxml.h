...
class dXmlanal {
	private:
		/***词法解析常量***/ 
//		static string	ant_blank	= " \n\r";		//空白符 
//		static string	ant_invalid	= "\'\"<>";	//文本中非法的内容 
		
		/***转意字符串***/ 
//		static char		anc_start	= '&';			//转移启动符 
//		static char		anc_end		= ';';			//转意结束符 
		
//		static string	ans_apos	= "apos";		//单引号 
//		static char		anc_apos	= '\'';			
//		static string	ans_quot	= "quot";		//双引号 
//		static char		anc_quot	= '\"';
//		static string	ans_lt		= "lt";			//左尖括号
//		static char		anc_lt		= '<'; 
//		static string	ans_gt		= "gt";			//右尖括号
//		static char		anc_gt		= '>'; 
//		static string	ans_amp		= "amp";		//与号
//		static char		anc_amp		= '&'; 
//		static string	ans_cr		= "cr";			//回车符 
//		static char		anc_cr		= '\r';
//		static string	ans_lf		= "lf";			//换行符 
//		static char		anc_lf		= '\n';
//		static string	ans_tab		= "tab";		//制表符 
//		static char		anc_tab		= '\t';
//		static string	ans_space	= "space";		//空白符 
//		static char		anc_space	= ' ';
